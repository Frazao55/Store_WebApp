    ...
    <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p>Dear {{$name}},</p>
            <p>Thank you for purchasing your order, it's currently being processed. We'll keep you updated with the latest news about your product.</p>
            <!--p>Thank you for purchasing your order. We'll keep you up to date with the latest news on your product.</p-->
